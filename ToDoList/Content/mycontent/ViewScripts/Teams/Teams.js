                ...
                },
                {
                    ...
                    "mRender": function (o) {
                        return '<div class="list-icons">'
                            + '<a href="/Teams/AddEdit/' + o.Id + '&IsViewOnly=true" class="fa fa-fw fa-eye" data-popup="tooltip" title="" data-container="body" data-original-title="View"><i class="icon-eye"></i></a>&nbsp;'
                            + '<a href="/Teams/AddEdit/' + o.Id + '" class="fa fa-fw fa-edit" data-popup="tooltip" title="" data-container="body" data-original-title="Edit"></a>&nbsp;'
...
function Status(id, status) {
    swal({
        ...
        if (isConfirm) {
            blockUI();
            $.post('/Teams/Status?id=' + id + "&status=" + status, function (response) {
                $.unblockUI();
                if (response == true) {
