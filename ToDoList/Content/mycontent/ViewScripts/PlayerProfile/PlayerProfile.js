    ...
    var table = $('.table').DataTable(
        {
            ...
            "ajax":
            {
                "url": "/PlayerProfile/LoadListItems?PositionId=" + $('#PositionId').val() + "&Name=" + $('#Name').val() + "&_Active=" + $('#Active').val(),
                "type": "Post",
                "datatype": "json",  
            },
            "columns": [
                ...
                { "data": "DateString" },  
                {
                    ...
                    "mRender": function (o) {
                        if (o.Image1 != null) {
                            return '<img width="100" heigh="100"  src=' + o.Image1 + ' />';
                        }
                        else {
                            return '';
                        }
                ...
                },
                {
                    ...
                    "mRender": function (o) {
                        return '<div class="list-icons">'
                            + '<a href="/PlayerProfile/AddEdit/' + o.Id + '&IsViewOnly=true" class="fa fa-fw fa-eye" data-popup="tooltip" title="" data-container="body" data-original-title="View"><i class="icon-eye"></i></a>&nbsp;'
                            + '<a href="/PlayerProfile/AddEdit/' + o.Id + '" class="fa fa-fw fa-edit" data-popup="tooltip" title="" data-container="body" data-original-title="Edit"></a>&nbsp;'
...
function Delete(id) {
    ...
    function (isConfirm) {
        if (isConfirm) {
            blockUI();
            $.ajax({
                url: '/PlayerProfile/Delete?Id=' + id,
                type: 'Post',
                cache: false,
...
function Status(id, status) {
    swal({
        ...
        if (isConfirm) {
            blockUI();
            $.post('/PlayerProfile/Status?id=' + id + "&status=" + status, function (response) {
                $.unblockUI();
                if (response == true) {
